...
Issueは、バグ報告、機能要望、ドキュメント、リリース・ストア申請、質問に分けて受け付けます。
...
| Documentation issue | docs、command reference、API referenceの不足やズレ | `documentation`, `needs-triage` |
| Release or store submission issue | GitHub Release、Chrome Web Store、AMO、validator、署名 | `chore`, `needs-triage` |
| Question | 使い方、設定、貢献方法、仕様確認 | `question`, `needs-triage` |
...
Release or store submission issueでは、対象version、対象channel、artifact名、workflow run、validator出力を確認します。
