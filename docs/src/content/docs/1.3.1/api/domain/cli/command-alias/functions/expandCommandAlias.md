...
slug: 1.3.1/api/domain/cli/command-alias/functions/expandcommandalias
---

> **expandCommandAlias**(`input`, `aliases`): `string`

Defined in: [domain/cli/command-alias.ts:162](https://github.com/itwillrain/bookmark-cli-extention/blob/eb34478ce004473c3f1997c55497345bb9ddd1c9/src/domain/cli/command-alias.ts#L162)
